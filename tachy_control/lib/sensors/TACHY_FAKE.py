...
from ..constants import PRISM_CONSTANT
...
class FakeTachy(TACHY.Tachy):

    def __init__(self, device):
        TACHY.Tachy.__init__(self)
        ...
        self.__laser_pointer = MAIN.OFF
        self.__face = FACE.FACE_ONE
        self.__compensator_cross = random.random()*1e-4
        self.__compensator_length = random.random()*1e-4
        self.__prism_constant = PRISM_CONSTANT.MINI_PRISM
        ...
        self.__search_horizontal = 0.0010
        self.__search_vertical = 0.0010
    ...
    def change_face(self):
        self.__face = 1 if self.__face == 0 else 0
    ...
    def set_search_windows(self, search_horizontal, search_vertical):
        """
        Setzt das Suchfenster
        :param search_horizontal: Suchfenster horizontal
        :type search_horizontal: float
        :param search_vertical: Suchfenster vertikal
