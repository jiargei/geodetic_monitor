# -*- coding: utf-8 -*-
# Generated by Django 1.9.2 on 2016-02-16 19:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='metering.Position')),
            ],
        ),
        migrations.CreateModel(
            name='Sensor',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='metering.Position')),
                ('sensor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='metering.Sensor')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='target',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='metering.Target'),
        ),
        migrations.AddField(
            model_name='position',
            name='sensors',
